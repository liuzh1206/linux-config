...
" viewer method:
" let g:vimtex_view_method = 'C:/Program Files/SumatraPDF/SumatraPDF.exe'
...
nmap <C-q> <CMD>NERDTreeToggle<CR>

autocmd bufenter * if (winnr("$") == 1 && exists("b:NERDTree") && b:NERDTree.isTabTree()) | q | endif

let $ZoteroSQLpath = '/mnt/e/Document/Zotero/Storage/zotero.sqlite'
imap jk <ESC>
